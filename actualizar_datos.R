...
func_tmap(mapa, LETALIDAD, "LETALIDAD", "LETALIDAD", "LETALIDAD")
func_tmap(mapa, INCID, "INCID.POR.MIL", "INCID.POR.MIL", "Incidencia c/100 mil. hab.")
func_tmap(mapa, POSITIVIDAD, "POSITIVIDAD", "Positividad", "Positividad")
# grafico
ggplot(
